    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-black">
            <div class="container-fluid ">
                <span><img src="https://img.icons8.com/small/32/ffffff/bull.png" /></span>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav   ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="LogoutServlet"><i class="bi bi-box-arrow-left "></i> Logout</a>
                        </li>
                        <%
                        } else {
                        %>
                        ...
                        <li class="nav-item justify-content-lg-end">
                            ...
                            <a class="nav-link" href="SubmitForm.jsp"><i class="bi bi-person-plus"></i> Sign-up</a>
                        </li>
                        <%
                            }
                        %>
